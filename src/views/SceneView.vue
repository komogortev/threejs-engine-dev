...
/** Hide the WASD hint after a few seconds on first input */
...
onMounted(async () => {
  ...
  // Dismiss hint on first movement
  ...
  // Auto-hide after 4 s regardless
...
<template>
  <div class="relative w-screen h-screen bg-black overflow-hidden">
    ...
    <!-- WASD hint — fades out on first input or after 4 s -->
    <Transition
