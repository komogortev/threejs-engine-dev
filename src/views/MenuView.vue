...
<template>
  <div class="flex flex-col items-center justify-center min-h-screen bg-zinc-950 gap-4 select-none">
    <div class="flex flex-col items-center gap-2 mb-8">
      ...
      <p class="text-xs font-medium tracking-[0.3em] uppercase text-zinc-500">Phase 2 dev harness</p>
    </div>
    ...
    <p class="absolute bottom-6 text-zinc-600 text-xs font-mono">
      Open console to observe engine:frame + entity:state-change events
    </p>
  </div>
</template>
